...
export function cloneWorkflowRunProgressItem(item: WorkflowRunProgressItem): WorkflowRunProgressItem {
  return {
    ...
    ...(item.acceptance !== undefined ? { acceptance: structuredClone(item.acceptance) } : {}),
    ...(item.scriptReceipt !== undefined ? { scriptReceipt: structuredClone(item.scriptReceipt) } : {}),
...
export function cloneWorkflowRun(run: WorkflowRunState): WorkflowRunState {
  return {
    ...
    ...(run.transaction !== undefined ? { transaction: structuredClone(run.transaction) } : {}),
    ...(run.operations !== undefined ? { operations: structuredClone(run.operations) } : {}),
    ...(run.recovery !== undefined ? { recovery: structuredClone(run.recovery) } : {}),
    ...(run.recoveryDecisions !== undefined ? { recoveryDecisions: structuredClone(run.recoveryDecisions) } : {}),
...
export function cloneWorkflowDraft(input: {
  ...
  return {
    ...
    ...(draft.origin ? { origin: structuredClone(draft.origin) } : {}),
