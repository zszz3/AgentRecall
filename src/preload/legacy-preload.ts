// Legacy full-product preload retained for compatibility work only.
// The production preload entrypoint is src/preload/index.ts and does not import this module.
